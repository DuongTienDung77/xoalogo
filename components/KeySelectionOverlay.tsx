...
export const KeySelectionOverlay: React.FC<KeySelectionOverlayProps> = ({ onSelectKey, isAistudioAvailable }) => {
  return (
    <div className="fixed inset-0 bg-gray-900 bg-opacity-90 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gray-800 border border-gray-700 rounded-2xl shadow-2xl p-6 sm:p-8 max-w-md w-full text-center">
        ...
        {isAistudioAvailable ? (
            ...
            <p className="text-red-400 mb-6 bg-red-900/20 p-4 rounded-lg">
                Không thể kết nối với AI Studio. Vui lòng đảm bảo bạn đang chạy ứng dụng này trong môi trường AI Studio để chọn Khóa API.
            </p>
        )}
